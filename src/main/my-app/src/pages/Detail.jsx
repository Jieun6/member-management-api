...
const Detail = () => {
    ...
    const handleEditBtnClick = async (e) => {
        e.preventDefault();
        navigate("/update-member", { state : { id: id, name: name, age: age, address: address } });
    }
        ...
        <>
            <Form className="custom-form">
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control id='input_name' type="text" value={name} disabled/>
                </Form.Group>
                ...
                <br/>
                <Button variant="primary" className="custom-button" type="button" onClick={handleEditBtnClick}>
                    멤버 수정
                </Button>
                <Button variant="secondary" className="custom-button" type="button"onClick={handleListBtnClick}>
                    목록으로
                </Button>
                <Button variant="primary" className="custom-button" type="button" onClick={handleDeleteBtnClick}>
                    삭제 하기
                </Button>
            </Form>
        </>
